...
import { getInputRange, setSelection } from '../focus/selection.js';
import '@testing-library/dom/dist/helpers.js';
import { getNextCursorPosition } from '../focus/cursor.js';
import '../keyDef/readNextDescriptor.js';
import '../misc/level.js';
import '../../options.js';
import { setUIValue, clearInitialValue, getUIValue, commitValueAfterInput } from '../../document/value.js';
import { buildTimeValue } from './buildTimeValue.js';
import { isValidDateOrTimeValue } from './isValidDateOrTimeValue.js';
import { getSpaceUntilMaxLength } from './maxLength.js';
...
function editContenteditable(config, element, inputRange, data, inputType) {
    ...
    if (del || data) {
        dispatchUIEvent(config, element, 'input', {
            inputType
        });
    }
}
